...
//  Ripple
//
//  Created by Cameron Bardell on 2020-06-18.
...
// Just for the preview. In use, only CustomSlider necessary
                ...
                Group {
                    ...
                    CustomSlider(value: $value, range: (0, 100), knobWidth: 0) { modifiers in
                      ZStack {
                        ...
                        Group {
                          LinearGradient(gradient: .init(colors: [Color.rippleBlue, Color.rippleYellow ]), startPoint: .leading, endPoint: .trailing)
...
extension Double {
    ...
    // Helper function to convert coords to values
...
struct CustomSlider<Component: View>: View {
    ...
    private func onDragChange(_ drag: DragGesture.Value,_ frame: CGRect) {
        ...
        withAnimation(.spring(response: 0.15, dampingFraction: 0.4, blendDuration: 0.2)) {
           self.value = value
        }
